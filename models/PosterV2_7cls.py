...
class pyramid_trans_expr3(nn.Module):
    ...
    def forward(self, x):
        ...
        #  x_ir1, x_ir2, x_ir3 [144, 64, 56, 56] [144, 64, 28, 28] [144, 128, 14, 14]
...
class pyramid_trans_expr2(nn.Module):
    def __init__(self, img_size=224, num_classes=7, window_size=[28,14,7], num_heads=[2, 4, 8], dims=[64, 128, 256], embed_dim=768):
        ...
        self.window_size = window_size
        self.N = [win * win for win in window_size]
        self.face_landback = seesaw_shuffleFaceNet(512)
        ...
        self.face_landback.load_state_dict(new_odict, strict=False)
